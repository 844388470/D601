...
const conf = {
  ...
  changeYearMonth(e){
    console.log(e)
    let newYear = Number(e.detail.value.substr(0,4));
    let newMonth = Number(e.detail.value.substr(5));
    this.setData({
...
export default (config = {}) => {
  ...
  const functionArray = ['tapDayItem', 'choosePrevMonth', 'chooseNextMonth', 'calendarTouchstart', 'calendarTouchmove','changeYearMonth'];
  // const defaultTheme = {
  //   color: '#88d2ac', // 日期色值
